...
describe("Scaffold a dragrams documentation skeleton", () => {
  it("should generate files", () => {
    return helpers.run(path.join(__dirname, "../generators/kroki"))
      .then(() => {
        ...
        assert(fs.existsSync(DOCKER_COMPOSE), `'${DOCKER_COMPOSE}' file should exist`);
        ...
        expect(dockerCompose.services).to.have.all.keys(["blockdiag", "kroki", "mermaid", "pandoc"]);
      });
  });
});
